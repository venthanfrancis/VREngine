...
| M10.5 | **Simple AR/XR demo**: a minimal scene, rendered stereo through Vulkan, driven by real head tracking (and, now that M10 exists, real controller input where available) | Not started | Fulfills the project's primary goal chain |
