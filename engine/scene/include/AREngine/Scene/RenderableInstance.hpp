...
namespace AREngine::Scene
{
    ...
    // entity's own local Transform), plus its mesh/tint. Backend-neutral
    // — no Vulkan/OpenXR type appears here — so it can be consumed by
    // any presentation path (desktop or XR) without either depending on
    // Scene. See docs/ARCHITECTURE.md, "M12 - Renderable Scene
